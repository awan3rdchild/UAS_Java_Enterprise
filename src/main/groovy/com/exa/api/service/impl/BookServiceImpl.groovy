...
class BookServiceImpl implements BookService {
    ...
    Book updateBook(Book book, Integer id) {
        ...
        if(updateCat != null) {
            updateCat.setJudul_buku(book.getJudul_buku())
            updateCat.setCategory(book.getCategory())
            updateCat.setPengarang(book.getPengarang())
            updateCat.setPenerbit(book.getPenerbit())
            updateCat.setTahun(book.getTahun())
        }
